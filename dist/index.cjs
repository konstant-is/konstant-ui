...
var Grid = ({ cols, gutter, asChild, children, className }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Comp, { className: (0, import_clsx.default)("grid", className), style: getStyles(), children });
};
...
var Stack = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Comp, { className: cn("stack"), style: { ...injectStyles, ...style }, ...props });
};
