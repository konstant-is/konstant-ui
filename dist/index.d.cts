...
declare const Gutter: React.FC<Props>;

export { type BreakpointValues, Grid, GridCol, type GridColProps, type GridProps, Gutter, type ResponsiveStyle, type ResponsiveValue, Stack, type StackProps, type UIComponentProps };
