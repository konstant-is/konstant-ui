import 'package:konstant_ui/impl/components/ui/button/button_builder.dart';
import 'package:konstant_ui/impl/components/ui/button/button_style.dart';
...
final button = UIButtonStyle(
  ...
  hoverStyle: BtnStyle(color: UIColors.twBlue600, textColor: Colors.white),
  activeStyle: BtnStyle(
    color: UIColors.twBlue900,
    textColor: Colors.white,
  ),
);
...
final primary = UIButtonStyle(
  ...
  textColor: Colors.white,
  hoverStyle: BtnStyle(color: UIColors.twBlue600, textColor: Colors.white),
  activeStyle: BtnStyle(color: UIColors.twBlue800, textColor: Colors.white),
);
...
final outline = UIButtonStyle(
  ...
  borderRadius: BorderRadius.circular(UIInsets.base),
...
final link = UIButtonStyle(
  textColor: UIColors.twGray950,
  hoverStyle: BtnStyle(textColor: UIColors.twGray800),
