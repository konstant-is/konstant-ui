...
import 'package:konstant_ui/impl/utils/utils.dart';
...
final _textStyle = UITextStyle(color: UIColors.twGray950, size: 12);
final _hintTextStyle = UITextStyle(color: UIColors.twGray500, size: 12);
final _labelTextStyle = UITextStyle(color: UIColors.twGray950, size: 12);
final _descriptionTextStyle = UITextStyle(color: UIColors.twGray500, size: 12);
